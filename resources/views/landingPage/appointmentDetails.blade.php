...
<body>
    ...
    <section class="order_details section_gap">
        <div class="container">
            ...
            <h3 class="title_confirmation">Thank you. Your Appointment has been received.</h3>
			...
			<div class="row order_d_inner">
				<div class="col-lg-12 ">
					<div class="details_item ">
						...
						<ul class="list">
							<li><a href="#"><span>Appointment number</span> : 60235</a></li>
							<li><a href="#"><span>Patient Namme</span> : Los Angeles</a></li>
