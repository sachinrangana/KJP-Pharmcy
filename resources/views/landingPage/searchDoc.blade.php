                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="/viewDoctor">Our Doctors</a></li>
    ...
    <section class="contact_area section_gap_bottom">
        <div class="container">
            ...
            <section class="blog_categorie_area">
                <div class="container">
                    <div class="row">
                        @foreach($searchDoc as $doc)
                        @if($doc->isActive == 1)
                        <div class="col-lg-4">

                            <div class="categories_post">
                                <img src="landingPage/img/blog/cat-post/cat-post-3.jpg" alt="post">
                                <div class="categories_details">
                                    <div class="categories_text">
                                        ...
                                        <p>Specialize : {{$doc->docCatergory}}</p>
                                        <p>Hospital : {{$doc->docHospital}}</p>
                                        <p>Qualification : {{$doc->docQulification}}</p>
                                    </div>
                                </div>
                            </div>
