    ...
    <section class="contact_area section_gap_bottom">
        <div class="container">
            ...
            <section class="contact_area section_gap_bottom">
                <div class="container">
                    <div class="mapouter">
                        <div class="gmap_canvas"><iframe width="1052" height="426" id="gmap_canvas"
                                src="https://maps.google.com/maps?q=%20Address:%20Haputhale%20Road,%20Wellawaya.&t=&z=13&ie=UTF8&iwloc=&output=embed"
                        ...
                        <div class="col-lg-3">
                            <div class="contact_info">
                                <div class="info_item">
                                    ...
                                    <h6>Address :</h6>
                                    <p>SHaputhale Road, Wellawaya.</p>
                                </div>
                                <div class="info_item">
                                    <i class="lnr lnr-phone-handset"></i>
                                    <h6><a href="#">(+94) 773912429.</a></h6>
                                    <p>Mon to Fri 8am to 10 pm</p>
                                </div>
                                <div class="info_item">
                                    <i class="lnr lnr-envelope"></i>
                                    <h6><a href="#">kodikaraj@gmail.com</a></h6>
