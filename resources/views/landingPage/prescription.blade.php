                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active "><a class="nav-link" href="/viewUserPrescription">Prescription</a></li>
    ...
    <section class="contact_area section_gap_bottom">
        <div class="container">
            <br>
                ...
                <form action="{{ url ('addPrescription')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Name  </label>
                            <input type="text" class="form-control" placeholder="name" name="userName"  id="userName">
                        </div>
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Age  </label>
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                            <label for="appointmentTime">Select Your Gender  </label>
                        ...
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Mobile Number  </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Appartment/Home No  </label>
                            <input type="text" class="form-control" placeholder="Address" name="address"  id="address" >
                        </div>
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Street </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your City </label>
                            <input type="text" class="form-control" placeholder="City" name="city"  id="city" >
                        </div>
                        <div class="col-md-6">
                            <label for="appointmentTime">Enter Your Postal Code </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="appointmentTime">Select Your Prescription Date</label>
                            <input type="date" class="form-control" placeholder="name" name="prescriptionDate"  id="prescriptionDate">
                        </div>

                        <div class="col-md-6">
                            <label for="appointmentTime">Upload Your Prescription</label>
                            <input type="file" class="form-control" placeholder="name" name="prescription"  id="prescription">
                        </div>
                    </div>

                    <br>
                    <div class="row">
                        <button type="submit" class="btn btn-primary">Submit Your Prescription</button>
                    </div>
